...
Top 11, Squad Analyst, Career Tracker, Byte Workbench, and Line-up Coach
(BETA). The editor stays byte-for-byte compatible with v1.2.
...
- **Squad Analyst** — per-team breakdown: roster size, position counts, average age and skill, youngest/oldest/best, on-market count. GUI: "— Squad Analyst (all teams)". CLI: `pm_cli.py squad-analyst [--team N]`.
- **Career Tracker** — diff two save slots to track skill, age, and team changes per player. GUI: **Tools → Career Tracker...**. CLI: `pm_cli.py career-tracker --save-a pm1.sav --save-b pm2.sav`.
...
- **Export** players as CSV or JSON. GUI: **File → Export Players...**. CLI: `pm_cli.py export-players --format csv|json`.
